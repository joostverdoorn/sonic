...
export declare module StateIterator {
    ...
    function findKey<V>(state: State<V>, fn: (value: V, key?: Key) => boolean | Promise<boolean>, range?: Range): Promise<Key>;
    function find<V>(state: State<V>, fn: (value: V, key?: Key) => boolean | Promise<boolean>, range?: Range): Promise<V>;
